...
// src/service.ts
var import_stakejs_core3 = require("@restake/stakejs-core");
...
// src/service.ts
var EthereumService = class extends import_stakejs_core3.ProtocolService {
  tx;
  constructor(network = { name: "mainnet" }, rpcUrl) {
    super();
    this.tx = new EthereumTransactionEngine(network, rpcUrl);
  }
  async stake(wallet, depositData, selector) {
