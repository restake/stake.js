...
__export(src_exports, {
  NEAR_PROTOCOL_DEFAULT_RPC_URLS: () => NEAR_PROTOCOL_DEFAULT_RPC_URLS,
  NEAR_PROTOCOL_NETWORKS: () => NEAR_PROTOCOL_NETWORKS,
  NearProtocolRawTransaction: () => NearProtocolRawTransaction,
  NearProtocolService: () => NearProtocolService,
...
// src/service.ts
var NearProtocolService = class extends import_stakejs_core2.ProtocolService {
  tx;
  constructor(network = { name: "mainnet" }, rpcUrl) {
    super();
